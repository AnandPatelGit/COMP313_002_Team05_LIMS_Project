...
public class StudentAvailableSubjects extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerTextViewInstructor.setText("Available Course's for  Student "+email);
        ...
        databaseReference.orderByChild("subjectProfessor").equalTo(email).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                arrayList.add(value);
                arrayAdapter = new ArrayAdapter<String>(StudentAvailableSubjects.this, android.R.layout.simple_list_item_1,arrayList);
                folderList.setAdapter(arrayAdapter);
                folderList.setOnItemClickListener(new StudentAvailableSubjects.FileListClickHandler());
            }
